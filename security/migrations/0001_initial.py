    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone_name', models.CharField(default='UTC', help_text='Временная зона устройства', max_length=50)),
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='arduino_devices', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
